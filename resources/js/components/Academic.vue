        ...
        <div class="row justify-content-center">
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">List of academic Item</h3>
...
<script>
    export default {
      ...
      methods: {
        ...
        createUser(){
          this.$Progress.start();
            this.form.post('api/academic').then(() => {
        ...
        updateUser(){
          this.$Progress.start();
             this.form.put('api/academic/'+ this.form.id)
            .then(() => {
    ...
    .then((willDelete) => {
     ...
     if(willDelete){
       this.form.delete('api/academic/'+$id).then( () => {
